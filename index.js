...
var compileCode = function (javascriptCode) {
  ...
  var script = new vm.Script(javascriptCode, {
...
var fixBytecode = function (bytecodeBuffer) {
  ...
  var dummyBytecode = compileCode('"ಠ_ಠ"');
...
var runBytecode = function (bytecodeBuffer) {
  ...
  var script = new vm.Script(dummyCode, {
...
var compileFile = function (args, output) {
  ...
  var compiledFilename = args.output || output || filename.slice(0, -3) + COMPILED_EXTNAME;

  if (typeof compiledFilename !== 'string') {
    throw new Error("output must be a string." + typeof(compiledFilename) +"was given.");
  }

  var javascriptCode = fs.readFileSync(filename, 'utf-8');
...
var runBytecodeFile = function (filename) {
  ...
  var bytecodeBuffer = fs.readFileSync(filename);
...
Module._extensions[COMPILED_EXTNAME] = function (module, filename) {
  ...
  */
  ...
  var args = [module.exports, require, module, filename, dirname, process, global];
